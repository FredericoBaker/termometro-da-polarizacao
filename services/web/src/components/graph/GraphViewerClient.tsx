...
function GraphEvents({
  ...
  }, [registerEvents, onNodeClick, onEdgeClick, onStageClick, onEdgeHover, sigma])
...
export default function GraphViewerClient({ graph }: { graph: Graph }) {
  ...
  const hoveredEdgeAttrs =
    hoveredEdge && graph.hasEdge(hoveredEdge.id)
      ? (graph.getEdgeAttributes(hoveredEdge.id) as unknown as EdgeAttrs)
      : null
